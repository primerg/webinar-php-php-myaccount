	...
	<div id="grid" class="tab-pane">
		<div class="col-sm-4 col-lg-3 col-md-3">
			...
			<div class="single-product">
				<div class="product-img">
					<a href="#">
						<img alt="" src="<?php echo url('/public/') ?>img/products/1.jpg" class="primary-image">
					</a>
				...
				<div class="product-des">
					...
					<div class="price-box">
						<span class="old-price"><strike>$222.00</strike></span>
		...
		<div class="col-sm-4 col-lg-3 col-md-3">
			...
			<div class="single-product">
				<div class="product-img">
					<a href="#">
						<img alt="" src="<?php echo url('/public/') ?>img/products/2.jpg" class="primary-image">
					</a>
					<div class="action-button-area">
						<div class="action-button">
							<a class="cart-button" href="#">Add to Cart</a>
